<?php
    ...
    if(!isset($_SESSION['id_usu'])){
        ...
        // Agregar esta línea para depurar el valor que estás recibiendo
        echo "Valor de venta_total: " . $venta_total;
        exit();
    ...
    id_usu_alta_cap, fecha_edit_cap, id_usu)
VALUES (
    ...
    '$nit_cc_ase', '$estado_cap', '$fecha_alta_cap', '$id_usu_alta_cap', '$fecha_edit_cap', '$id_usu')";
