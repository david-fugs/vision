            ...
            <div class="form-group">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-2">
                            <label for="tipo_bodega_cap">TIPO DE BODEGA:</label>
                            <select class="form-control" name="tipo_bodega_cap" id="tipo_bodega_cap">
                                <option value=""></option>   
                                <option value="Industriales">Industriales</option>
                                <option value="Comerciales">Comerciales</option>
                                <option value="Logísticas">Logísticas</option>
                                <option value="Usos Mixtos">Usos Mixtos</option>
                            </select>
                        </div>
                        <div class="col-12 col-sm-2">
