...
//traer los datos de capta_residencial por el id
$id_capr = $_GET['id_capr'] ?? "";
$captacion = "";
if ($id_capr != "") {
    $sql = "SELECT * FROM capta_residencial WHERE id_capr = $id_capr";
...
<body>
    ...
    <div class="container">
        ...
        <form action='processCapResiden.php' enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <select class="form-control" name="estrato_cap" id="estrato_cap">
                                ...
                                $estrato_selected = isset($captacion['estrato_capr']) ? (int)$captacion['estrato_capr'] : null;
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-2">
                            ...
                            <input
                                type="number"
                                name="venta_neta_capr"
                                class="form-control"
                                id="venta_neta_cap"
                                step="0.1"
                                value="<?php echo isset($captacion['venta_neta_capr']) && is_numeric($captacion['venta_neta_capr']) ? htmlspecialchars($captacion['venta_neta_capr'], ENT_QUOTES, 'UTF-8') : '0'; ?>" />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="venta_m2_capr">* VENTA x m2:</label>
                            <input type='number' name='venta_m2_capr' class='form-control' id="venta_m2_cap" step='0.1'
                                value="<?php echo isset($captacion['venta_m2_capr']) && is_numeric($captacion['venta_m2_capr']) ? htmlspecialchars($captacion['venta_m2_capr'], ENT_QUOTES, 'UTF-8') : '0'; ?>" />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="canon_neto_capr">* CANON NETO $</label>
                            <input
                                type="number"
                                name="canon_neto_capr"
                                class="form-control"
                                id="canon_neto_capr"
                                step="0.1"
                                value="<?php echo !empty($captacion['canon_neto_capr']) ? htmlspecialchars($captacion['canon_neto_capr']) : ''; ?>" />
                        </div>
                        <div class="col-12 col-sm-2">
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='number' name='porcentaje_iva_capr' class='form-control' id="porcentaje_iva_capr" min='0.0' max='100' step='0.1' value="<?php echo !empty($captacion['porcentaje_iva_capr']) ? htmlspecialchars($captacion['porcentaje_iva_capr']) : 19.0; ?>" />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="valor_iva_capr">* VALOR IVA $</label>
                            <input type='number' name='valor_iva_cap_hidden' class='form-control' id='valor_iva_cap_hidden' value="<?php echo !empty($captacion['valor_iva_capr']) ? htmlspecialchars($captacion['valor_iva_capr']) : ''; ?>" />
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='number' name='admon_capr' class='form-control' id="admon_cap" step='0.1' value="<?php echo !empty($captacion['admon_capr']) ? htmlspecialchars($captacion['admon_capr']) : '0'; ?>" />
                        </div>
                        <div class="col-12 col-sm-2">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='number' name='cel_repre_legal_capr' id="cel_repre_legal_cap" class='form-control'
                                value="<?php
                                        echo !empty($captacion['cel_repre_legal_capr']) ? $captacion['cel_repre_legal_capr'] : '0'; ?>" required />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="tel_repre_legal_capr">TELEFONO:</label>
                            <input type='number' value="<?php
                                                        echo !empty($captacion['tel_repre_legal_capr']) ? $captacion['tel_repre_legal_capr'] : '0'; ?>" name='tel_repre_legal_capr' id="tel_repre_legal_capr" class='form-control' />
                        </div>
