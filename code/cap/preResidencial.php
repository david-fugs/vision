...
<body>
    ...
    <div class="container">
        <h1><img src='../../img/logo.png' width="80" height="56" class="responsive"><b><i class="fa-solid fa-building-circle-check"></i> FICHA TECNICA INMUEBLES RESIDENCIALES</b></h1>
        <p><i><b>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='text' name='sector_capr' class='form-control' id="sector_cap" />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="ubicacion_gps_cap">UBICACION GPS:</label>
                            <input type='text' name='ubicacion_gps_capr' class='form-control' id="ubicacion_gps_cap" readonly />
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <select class="form-control" name="estrato_capr" id="estrato_cap" required>
                                <option value=""></option>
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='number' name='area_total_capr' class='form-control' id="area_total_cap" />
                        </div>
                    </div>
                </fieldset>
            </div>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='number' value=0 name='cel_repre_legal_capr' id="cel_repre_legal_cap" class='form-control' required />
                        </div>
                        <div class="col-12 col-sm-2">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='text' name='canon_neto_capr' class='form-control' id="canon_neto_cap" step='0.1' value="0" />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="porcentaje_iva_cap">% IVA:</label>
                            <input type='number' name='porcentaje_iva_capr' class='form-control' id="porcentaje_iva_cap" min='0.0' max='100' step='0.1' value=19.0 />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="admon_cap">* ADMINISTRACION $</label>
                            <input type='text' name='admon_capr' class='form-control' id="admon_cap" step='0.1' required />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="valor_iva_cap">* VALOR IVA $</label>
                            <input type='text' name='valor_iva_capr' class='form-control' id="valor_iva_cap" readonly style="font-weight: bold; font-size: 14px;" />
                            <input type='hidden' name='valor_iva_cap_hidden' id='valor_iva_cap_hidden' />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="renta_total_cap">* RENTA TOTAL $</label>
                            <input type='text' name='renta_total_capr' class='form-control' id="renta_total_cap" readonly style="font-weight: bold; font-size: 14px;" />
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-2">
                            ...
                            <input type='text' name='venta_neta_capr' class='form-control' id="venta_neta_cap" step='0.1' value="0" />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="venta_m2_cap">VALOR x m2 $</label>
                            <input type='text' name='venta_m2_capr' class='form-control' id="venta_m2_cap" step='0.1' />
                        </div>
                        <div class="col-12 col-sm-2">
                            <label for="venta_total">VALOR TOTAL $</label>
                            <input type='text' name='venta_totalr' class='form-control' id="venta_total" readonly style="font-weight: bold; font-size: 14px;" />
