...
<body>
    ...
    <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em; font-size: 40px; text-align: center;"><b><i class="fa-solid fa-store"></i> FICHA COMERCIAL</b>
    </h1>
...
while($row = mysqli_fetch_array($result))
{
    ...
    $completo = "";
    $edicion = "";
    if($row['comercial_completa'] == 0) {
        $color = 'bisque';
        $completo = 'NO';
        $edicion = ' <td ><a href="addcap2.php?id_cap='.$row['id_cap'].'" target="_blank"><img src="../../img/editar.png" width="32" height="32" title="Completar ficha comercial" /></a></td>';
    } else {
        $color = 'cadetblue';
        $completo = 'SI';
        $edicion = "<td></td>";
