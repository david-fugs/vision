...
<body >
    ...
    ?>
   	...
   	<div class="container">
        ...
        <BR/>
        <h1><b><i class="fa-solid fa-file-signature"></i> REALIZAR MODIFICACIÓN CONTRATO</b></h1>
        <p><i><b><font size=3 color=#c68615>*Datos obligatorios</i></b></font></p>
    
        <form action='editcont1.php' enctype="multipart/form-data" method="POST">
            
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-2">
                        <label for="num_con">CONTRATO No.</label>
                        <input type='text' name='num_con' class='form-control' id="num_con" value='<?php echo $row['num_con']; ?>' readonly />
                    </div>
                    <div class="col-12 col-sm-2">
                        <label for="fec_con">* FECHA</label>
                        <input type='date' name='fec_con' class='form-control' id="fec_con" value='<?php echo $row['fec_con']; ?>'/>
                    </div>
