<?php
  ...
  include("../../conexion.php");
	...
	$sql = "SELECT * FROM inmuebles WHERE mat_inm = '$mat_inm'";
     ...
     <section class="principal">
      ...
      <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
        ...
        <div align="center">
          ...
          <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em; font-size: 40px; text-align: center;"><b><i class="fa-solid fa-city"></i> DOCUMENTOS INMUEBLES </b></h1>
        ...
        <br>
        <center>
            <br/><a href="showinm.php"><img src='../../img/atras.png' width="72" height="72" title="Regresar" /></a>
        </center>
    </div>
</section>
