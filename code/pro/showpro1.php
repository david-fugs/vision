<?php
  ...
  include("../../conexion.php");
	...
	$sql = "SELECT * FROM propietarios WHERE nit_cc_pro = '$nit_cc_pro'";
     ...
     <section class="principal">
      ...
      <div style="border-radius: 9px 9px 9px 9px; -moz-border-radius: 9px 9px 9px 9px; -webkit-border-radius: 9px 9px 9px 9px; border: 4px solid #FFFFFF;" align="center">
        ...
        <div align="center">
          ...
          <h1 style="color: #412fd1; text-shadow: #FFFFFF 0.1em 0.1em 0.2em; font-size: 40px; text-align: center;"><b><i class="fa-solid fa-address-card"></i> DOCUMENTOS PROPIETARIOS </b></h1>

        </div>

        <?php 
        $path = "files/".$nit_cc_pro;
        if(file_exists($path)) {
            ...
            while ($archivo = readdir($directorio)) {
                if (!is_dir($archivo)) {
                    ...
                    echo "<p>$archivo</p>";
                    echo "<a href='$path/$archivo' title='Ver Archivo Adjunto' target='_blank'><img src='../../img/consultar.png' alt='Ver Archivo Adjunto' width=60 heigth=60></a>";
        ...
        <br>
        <center>
            <br/><a href="showpro.php"><img src='../../img/atras.png' width="72" height="72" title="Regresar" /></a>
        </center>
    </div>
</section>
